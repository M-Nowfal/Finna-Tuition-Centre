...
import { isValidPh } from "../helpers/formValidation";
...
const AddStaff = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      setLoading(true);
      isValidPh(staffNumber);
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/auth/add-staff`, {staffNumber});
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col gap-5 mb-5">
          ...
          <div className="flex flex-col items-center">
            <span className="text-2xl font-bold">Add new Staff</span>
            <p className="text-gray-600">Only super admin can add staffs</p>
          </div>
